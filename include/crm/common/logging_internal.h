 ...
 */
enum pcmk__warnings {
    pcmk__wo_blind                  = (UINT64_C(1) << 0),
    pcmk__wo_record_pending         = (UINT64_C(1) << 1),
    pcmk__wo_enable_startup_probes  = (UINT64_C(1) << 2),
    pcmk__wo_concurrent_fencing     = (UINT64_C(1) << 3),
    pcmk__wo_require_all            = (UINT64_C(1) << 4),
    pcmk__wo_order_score            = (UINT64_C(1) << 5),
    pcmk__wo_cancel_removed_actions = (UINT64_C(1) << 6),
    pcmk__wo_stop_removed_resources = (UINT64_C(1) << 7),
    pcmk__wo_group_order            = (UINT64_C(1) << 11),
    pcmk__wo_group_coloc            = (UINT64_C(1) << 12),
    pcmk__wo_set_ordering           = (UINT64_C(1) << 15),
    pcmk__wo_rdisc_enabled          = (UINT64_C(1) << 16),
    pcmk__wo_op_attr_expr           = (UINT64_C(1) << 19),
    pcmk__wo_clone_master_max       = (UINT64_C(1) << 23),
    pcmk__wo_clone_master_node_max  = (UINT64_C(1) << 24),
    pcmk__wo_master_role            = (UINT64_C(1) << 26),
    pcmk__wo_slave_role             = (UINT64_C(1) << 27),
};
