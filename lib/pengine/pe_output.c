...
cluster_options_xml(pcmk__output_t *out, va_list args) {
    ...
    pcmk__xe_set_uint(xml, PCMK_XA_FENCING_TIMEOUT_MS,
    ...
    pcmk__xe_set_uint(xml, PCMK_XA_PRIORITY_FENCING_DELAY_MS,
    ...
    pcmk__xe_set_uint(xml, PCMK_XA_STONITH_TIMEOUT_MS,
                      scheduler->priv->fence_timeout_ms);
...
failed_action_xml(pcmk__output_t *out, va_list args) {
    ...
    if (epoch > 0) {
        ...
        pcmk__xe_set_uint(xml, PCMK_XA_INTERVAL, interval_ms);
